...
def get_lab_documents(patient_id: str):
    return get_documents_by_type(patient_id, "24323-8")  # Lab Report


def get_radiology_documents(patient_id: str):
    return get_documents_by_type(patient_id, "18748-4")  # Radiology Report


def get_clinical_notes(patient_id: str):
    return get_documents_by_type(patient_id, "34109-9")  # Outpatient Note
